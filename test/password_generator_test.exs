defmodule PasswordGeneratorTest do
  ...
  test "returns erros when no lenght is given", %{result: _result} do
    options = %{
      "invalid" => "false"
    }
  ...
  test "length of returned string is the provided by the option" do
    length_options = %{
      "length" => "5"
    }
  ...
  test "returns a uppercase string just with the length", %{options_type: options} do
  ...
  test "returns string with symbols and uppercase", %{options_type: options} do
    ...
    {:ok, result} = PasswordGenerator.generate(options_symbols_and_uppercase)
  ...
  test "returns string with symbols and numbers", %{options_type: options} do
    ...
    {:ok, result} = PasswordGenerator.generate(options_symbols_and_numbers)
